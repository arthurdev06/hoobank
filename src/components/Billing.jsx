    ...
    <section id="product" className={layout.sectionReverse}>
        ...
        <div className={layout.sectionInfo}>
            ...
            <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
                ...
                delectus obcaecati, id nostrum magnam autem accusamus esse
                repudiandae porro voluptatibus laborum corporis quis doloribus.
                Sint porro veritatis quis accusamus labore!
            </p>
